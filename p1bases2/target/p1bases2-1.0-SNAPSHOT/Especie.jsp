...
<body>
		...
		<tbody>
			<% 
				try{
					...
					PreparedStatement pst = con.prepareStatement("SELECT * FROM especie");
	...
	<button onclick="window.location.href='menuPrincipal.jsp'">Regresar al menú principal</button>
        <button onclick="window.location.href='buscarEspecie.jsp'">Buscar registro en la tabla</button>
</body>
</html>
