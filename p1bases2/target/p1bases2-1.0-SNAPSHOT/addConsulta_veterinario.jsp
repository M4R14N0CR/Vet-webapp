...
<head>
	<meta charset="UTF-8">
	<title>Agregar Registro a la tabla Consulta_veterinario</title>
	<style>
		body {
...
<body>
	<h1>Agregar Registro a la tabla Consulta_veterinario</h1>
	...
	<% 
		if(request.getMethod().equalsIgnoreCase("post")){
			try{
				...
				String id_veterinario = request.getParameter("id_veterinario");

				PreparedStatement pst = con.prepareStatement("INSERT INTO CONSULTA_VETERINARIO (ID_CONSULTA, ID_VETERINARIO) VALUES (?, ?)");
				pst.setString(1, id_consulta);
				pst.setString(2, id_veterinario);
...
<form method="post">
	...
	<label for="nombre">ID Veterinario:</label>
	<input type="text" id="id_veterinario" name="id_veterinario" required>

	<button type="submit">Agregar</button>
</form>

<a href="Consulta_veterinario.jsp">Volver a la tabla Consulta_veterinario</a>
</body>
</html>
