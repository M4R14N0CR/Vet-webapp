...
<head>
	<meta charset="UTF-8">
	<title>Borrar registro de la Consulta_mascota</title>
</head>
<body>
	<h1>Borrar registro de la Consulta_mascota</h1>
	...
	<% 
		try{
			...
			PreparedStatement pst = con.prepareStatement("DELETE FROM Consulta_mascota WHERE ID_CONSULTA=?");
			pst.setString(1, id);
	...
	<br>
	<a href="Consulta_mascota.jsp">De vuelta a la tabla Consulta_mascota</a>
