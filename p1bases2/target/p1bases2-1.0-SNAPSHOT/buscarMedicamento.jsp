...
<head>
	<meta charset="UTF-8">
	<title>Buscar registro en la tabla medicamento</title>
	<style>
		body {
...
<body>
	<h1>Buscar registro en la tabla Medicamento</h1>
        
<form method="post" action="buscarMedicamento.jsp">
		...
		if(request.getMethod().equalsIgnoreCase("post")){
			try{
				...
				String busqueda = request.getParameter("busqueda");
                                String sql = "SELECT * FROM MEDICAMENTO WHERE ID LIKE '%"+busqueda+"%' OR NOMBRE LIKE '%"+busqueda+"%' OR PRECIO LIKE '%"+busqueda+"%'";
