...
<head>
	<meta charset="UTF-8">
	<title>Borrar registro de la tabla raza</title>
</head>
<body>
	<h1>Borrar registro de la tabla raza</h1>
	...
	<% 
		try{
			...
			PreparedStatement pst = con.prepareStatement("DELETE FROM raza WHERE id=?");
			pst.setString(1, id);
	...
	<br>
	<a href="Raza.jsp">De vuelta a la tabla raza</a>
