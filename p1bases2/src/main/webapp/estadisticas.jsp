...
<p>Total venta del mes <%= currentMonth %> del a�o <%= currentYear %>: <%= String.format("%.2f", totalMes) %></p>
    <p>Total venta del a�o <%= currentYear %>: <%= String.format("%.2f", totalAnio) %></p>
    <p>Total venta del d�a <%= currentDay %>/<%= currentMonth %>/<%= currentYear %>: <%= String.format("%.2f", totalDia) %></p>
