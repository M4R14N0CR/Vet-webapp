...
<head>
	<meta charset="UTF-8">
	<title>Agregar Registro a la tabla Especie</title>
	<style>
		body {
...
<body>
	<h1>Agregar Registro a la tabla Especie</h1>
	...
	<% 
		if(request.getMethod().equalsIgnoreCase("post")){
			try{
				...
				PreparedStatement pst = con.prepareStatement("INSERT INTO ESPECIE (ID, NOMBRE) VALUES (secuencia_especie.nextval, ?)");
