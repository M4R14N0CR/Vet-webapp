...
<head>
	<meta charset="UTF-8">
	<title>Agregar Registro a la tabla Raza</title>
	<style>
		body {
...
<body>
	<h1>Agregar Registro a la tabla Raza</h1>
	...
	<% 
		if(request.getMethod().equalsIgnoreCase("post")){
			try{
				...
				PreparedStatement pst = con.prepareStatement("INSERT INTO RAZA (ID, NOMBRE) VALUES (secuencia_raza.nextval, ?)");
