...
<head>
	<meta charset="UTF-8">
	<title>Buscar registro en la tabla raza</title>
	<style>
		body {
...
<body>
	<h1>Buscar registro en la tabla Raza</h1>
        
<form method="post" action="buscarRaza.jsp">
		...
		if(request.getMethod().equalsIgnoreCase("post")){
			try{
				...
				String busqueda = request.getParameter("busqueda");
                                String sql = "SELECT * FROM RAZA WHERE ID LIKE '%"+busqueda+"%' OR NOMBRE LIKE '%"+busqueda+"%'";
